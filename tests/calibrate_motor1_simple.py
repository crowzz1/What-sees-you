...
def main():
    ...
    time.sleep(0.1)
    current_pos = driver.get_position(1)
    driver.set_torque_enable(1, False)
    time.sleep(0.1)
    ...
    driver.set_torque_enable(1, True)
    time.sleep(0.1)
    verify_pos = driver.get_position(1)
    driver.set_torque_enable(1, False)
    ...
    # 清除限制
    driver.clear_position_limits(1)
    print()
    ...
    print(f"    1: {{'center': 2048, 'min': {min_pos}, 'max': {max_pos}, 'name': '基座'}},")
    print("    ...")
    print("}")
    print()
    ...
    print("  -> 中间位置 (2048)")
    driver.set_position(1, 2048)
    time.sleep(2)
    
    print(f"  -> 最小位置 ({min_pos})")
    driver.set_position(1, min_pos)
    time.sleep(2)
